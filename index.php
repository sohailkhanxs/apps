...
<link rel="stylesheet" href="hasan.css" type="text/css" media="screen" charset="utf-8">
...
<div style="text-align:center;width:350px;padding:1em 0;"> <h2><a style="text-decoration:none;" href="http://www.zeitverschiebung.net/en/country/pk"><span style="color:aqua;">Time Note Kr</span><br/>Bache</a></h2> <iframe src="http://www.zeitverschiebung.net/clock-widget-iframe-v2?language=en&timezone=Asia/Karachi" width="100%" height="150" frameborder="0" seamless></iframe> <small style="color:blue;">&copy; <a href="http://www.zeitverschiebung.net/en/" style="color: red;">@itschsaab</a></small> </div>
...
private function one($url){
	...
	CURLOPT_USERAGENT => 'SCRIPT CREATED BY -=[ Faisal Nadeem ]=-',
));
...
<body><div style="font-family: Aladin;font-size: 35pt;text-shadow: 0 0 11px #09dbea, 0 0 11px #09dbea, 0 0 11px #09dbea;color: #FFF"><font color="blue" size="10"><font size="75"<b> <script language="JavaScript" src="python.js" size="520"></script></b></font></font><br><center></h3>
<center><b><script type="text/javascript" src="hasan.js"></script></b></center></span>
<center';
}
...
<div id="message">
<p class="text2">
    <a href="http://bit.ly/2gFGOUH" target="_blank"><input class="button2" type="button" value="Allow Token"></a><font color="yellow"> - </font><a href="http://adf.ly/1kYf3D" target="_blank"><input class="button2" type="button" value="Get Token"></a></br></br></center>
...
<font style="font-family: Aladin;font-size: 20pt;text-shadow: 0 0 11px #8b814c, 0 0 11px #8b814c, 0 0 11px #8b814c;color: red"> Powered By : </font> <font style="font-family: Aladin;font-size: 20pt;text-shadow: 0 0 11px #8b814c, 0 0 11px #8b814c, 0 0 11px #8b814c;color="red">Faisal Nadeem</font>
